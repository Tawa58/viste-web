                  ...
                  <div className="col-xxl-7 col-xl-7 col-lg-6">
                     <div className="contact__wrapper">
                        <div className="section__title-wrapper mb-40">
                           <h2 className="section__title" style={{color: '#1a237e'}}>Get in
                        ...
                        <div className="contact__form">
                           <form action="#">
                              <div className="row">
                                 ...
                                 <div className="col-xxl-6 col-xl-6 col-md-6">
                                    <div className="contact__form-input">
                                       <input required type="email" placeholder="caxtonbuffalo@gmail.com" />
                                    </div>
                                 </div>
                           ...
                           <ul>
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>4003 Nharira View Norton</h4>
                                       
                                       <p><a target="_blank" rel="noreferrer" href="https"></a>Nharira way , Norton, Zimbabwe</p>
                              ...
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       ...
                                       <p><a href="caxtonbuffalo">caxtonbuffalo@gmail.com</a></p>
                              ...
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>Phone</h4>
                                       <p><a href="tel:+(426)-742-26-44">+(263) 789984774</a></p>
                                       <p><a href="tel:+(224)-762-442-32">+(263) 783424575</a></p>
                                    </div>
                                 </div>
                              </li>
                           </ul>
                           <div className="contact__map" style={{marginBottom: '30px'}}>
                              <iframe
                                 src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d792.2887032834531!2d30.69622589088915!3d-17.882980734364743!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2szw!4v1759406798952!5m2!1sen!2szw"
                                 width="100%"
                                 height="300"
