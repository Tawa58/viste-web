    ...
    <section className="achievement__area pt-60 pb-120">
      <div className="container">
        <div className="row">
          <div className="col-xxl-12">
            <div className="section__title-wrapper text-center mb-60">
              <h2 className="section__title" style={{ color: '#1a237e', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <i className="fas fa-trophy" style={{ color: '#ffd700', marginRight: '10px', fontSize: '1.2em' }}></i> 
                Our Achievements
              </h2>
            </div>
          </div>
        ...
        <div className="row">
          ...
          {achievementsData.length > 0 && (
            <div className="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
              ...
              >
                ...
                <div
                  className="achievement__content p-relative pt-1 pb-3 px-3"
          ...
          {/* Second tile - completely separate and independent */}
              ...
              >
                <div
                  ...
                  style={{
                    position: "relative",
                    width: "100%",
                    height: "230px", // Second tile container height - EDIT HERE
                    background: "#fff",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <Image
                    src={achievementsData[1].img_bg}
                    alt={achievementsData[1].title}
                    width={280} // Second tile image width - EDIT HERE
                    height={280} // Second tile image height - EDIT HERE
                    className="achievements-image"
                  />
                </div>
                <div
                  className="achievement__content p-relative pt-0 pb-3 px-3"
                  style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}
                >
                  <div className="achievement__tag mb-2">
                    <span style={{ fontWeight: 600, color: "#1976d2" }}>{achievementsData[1].tutor_name}</span>
                  </div>
                  <h3 className="achievement__title mb-2" style={{ color: "#1a237e", fontWeight: 700, fontSize: "1.25rem" }}>
                    {achievementsData[1].title}
                  </h3>
                  <p className="mb-2" style={{ fontSize: "1.05rem", color: "#333", minHeight: "60px" }}>
                    {achievementsData[1].description}
                  </p>
                  <div className="achievement__bottom d-sm-flex align-items-center justify-content-between">
                    <p className="achievement__year mb-0" style={{ color: "#1976d2", fontWeight: 600 }}>
                      {achievementsData[1].date}
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Remaining tiles (3-6) - completely separate and independent */}
          {achievementsData.slice(2).map((achievement) => (
